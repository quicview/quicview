...
lazy_static::lazy_static! {
    ...
    // DEPRECATED: P2P rendezvous server config — QuicView uses direct connections
    // These are kept for legacy code compatibility but should not be used in new code.
    pub static ref PROD_RENDEZVOUS_SERVER: RwLock<String> = RwLock::new("".to_owned());
    pub static ref EXE_RENDEZVOUS_SERVER: RwLock<String> = Default::default();
    
    pub static ref APP_NAME: RwLock<String> = RwLock::new("QuicView".to_owned());
...
// ──────────────────────────────────────────────────────────────────────────────
// DEPRECATED: P2P / Rendezvous constants — QuicView uses client-server architecture
// These are kept for legacy compatibility with existing code but should not be
// used in new code. Use crates/config for QuicView's new config schema.
// ──────────────────────────────────────────────────────────────────────────────

/// Deprecated: RustDesk rendezvous servers. QuicView connects directly to servers.
#[deprecated(since = "2.0.0", note = "QuicView uses direct server connections, not rendezvous")]
pub const RENDEZVOUS_SERVERS: &[&str] = &["rs-ny.rustdesk.com"];

/// Deprecated: RustDesk public key. Not used in QuicView.
#[deprecated(since = "2.0.0", note = "QuicView uses its own TLS certificates")]
pub const RS_PUB_KEY: &str = "OeVuKk5nlHiXp+APNn0Y3pC1Iwpwn44JGqrQCsWqmBw=";

/// Deprecated: Rendezvous server port. QuicView uses configurable ports via crates/config.
#[deprecated(since = "2.0.0", note = "Use crates/config for port configuration")]
pub const RENDEZVOUS_PORT: i32 = 21116;

/// Deprecated: Relay server port. QuicView doesn't use relays.
#[deprecated(since = "2.0.0", note = "QuicView uses direct connections, no relays")]
pub const RELAY_PORT: i32 = 21117;

/// Deprecated: WebSocket rendezvous port. QuicView uses QUIC.
#[deprecated(since = "2.0.0", note = "QuicView uses QUIC, not WebSocket for transport")]
pub const WS_RENDEZVOUS_PORT: i32 = 21118;

/// Deprecated: WebSocket relay port. QuicView doesn't use relays.
#[deprecated(since = "2.0.0", note = "QuicView uses direct connections, no relays")]
...
impl Config {
    ...
    // ──────────────────────────────────────────────────────────────────────────
    // DEPRECATED: Rendezvous server functions — QuicView uses direct connections
    // ──────────────────────────────────────────────────────────────────────────
    
    /// Deprecated: QuicView connects directly to servers. Use crates/config instead.
    #[deprecated(since = "2.0.0", note = "QuicView uses direct server connections via crates/config")]
    #[allow(deprecated)]
    ...
    /// Deprecated: QuicView doesn't track rendezvous server latency.
    #[deprecated(since = "2.0.0", note = "QuicView uses direct connections")]
    pub fn reset_online() {
