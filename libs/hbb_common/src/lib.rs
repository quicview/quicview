...
pub use protos::control as control_proto;

// ──────────────────────────────────────────────────────────────────────────────
// DEPRECATED: P2P / Rendezvous code — QuicView uses client-server architecture
// ──────────────────────────────────────────────────────────────────────────────
/// Deprecated: QuicView no longer uses P2P rendezvous. Kept for legacy compatibility.
#[deprecated(since = "2.0.0", note = "QuicView uses client-server, not P2P rendezvous")]
...
// ──────────────────────────────────────────────────────────────────────────────
// DEPRECATED: P2P networking modules — QuicView uses direct QUIC/TCP connections
// ──────────────────────────────────────────────────────────────────────────────
/// Deprecated: SOCKS proxy for P2P connections. QuicView uses direct connections.
#[deprecated(since = "2.0.0", note = "QuicView uses direct QUIC/TCP, not SOCKS proxy")]
pub mod proxy;

/// Deprecated: Socket client with rendezvous/relay logic. Use transport crate instead.
#[deprecated(since = "2.0.0", note = "Use crates/transport for QUIC/TCP connections")]
pub mod socket_client;

/// TCP utilities - still useful for general TCP connections.
pub mod tcp;

/// Deprecated: UDP for P2P punch-hole. QuicView uses QUIC which handles UDP internally.
#[deprecated(since = "2.0.0", note = "QuicView uses QUIC (quinn) for UDP-based transport")]
pub mod udp;
...
// ──────────────────────────────────────────────────────────────────────────────
// DEPRECATED: tokio_socks for P2P proxy — QuicView uses direct QUIC/TCP
// ──────────────────────────────────────────────────────────────────────────────
#[deprecated(since = "2.0.0", note = "QuicView uses direct connections, not SOCKS proxy for P2P")]
pub use tokio_socks;
