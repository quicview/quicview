//! Socket client utilities for TCP/UDP connections.
//!
//! NOTE: This module is largely deprecated for QuicView. Use `crates/transport` for
//! QUIC/TCP connections. The functions here are kept for legacy compatibility.
